...
<form method="post" action="userdetails">
	<ul style="list-style: none">
		<li>User Name: <input name="username" type="text" value="" />
		</li>
		<li>Password: <input name="password" type="text" value="" />
		</li>
		<li>Organisation Details Id: <input name="organisationDetailsID"
			type="text" value="" />
		</li>
	</ul>
